...
\begin{document}
\name{\firstName\ \secondName\ \lastName}
\tagline{\job}
\photoR{2.5cm}{\imageFileName}
...
\wheelchart{1.5cm}{0.5cm}{%
  ...
  5/8em/accent!20/\footnotesize Time on SO \& asking ChatGPT where to even start,
...
\cvachievement{\faChartLine}{Focus}{As an engineer, I am solution-driven and focusing on data \& numbers, rather than feelings.}

\divider

\cvachievement{\faFemale}{Women in Tech}{Colleagues respect my skills and abilities without gender judgment.}

\divider

\cvachievement{\faHeartbeat}{Teamwork \& Giving back help}{I make time to help others, having experienced the value of colleagues' assistance.}

...
\definecolor{cvblue}{HTML}{333333} %1E3A8A 3C3C3C
%\definecolor{cvblue}{HTML}{FF0000} %1E3A8A 3C3C3C
\newcommand{\is}{\par\vskip.5ex plus .4ex} 

\newcommand{\job}[3]{%
    \is
    \textbf{\textcolor{cvblue} {\MakeUppercase{#1}}}\\
    \textbf{#2} \dates{#3}
}
...
\begin{tikzpicture}
    ...
    \node at (0,0) {\includegraphics[width=3.5cm]{aaf.jpg}}; 
\end{tikzpicture}%
\hfill\null
...
{\small
\justifying
\noindent Software Engineer with 5+ years of experience. Since the beginning of my career, I have contributed to diverse projects across industries like telecommunications, automotive, and energy, building applications from scratch, implementing new features, and finding solutions. As a team player, I enjoy working in agile, international teams.
Beyond my technical skills, I am flexible, communicative, and always eager to learn new technologies and share knowledge. If there are any tools or technologies that I am not yet familiar with, I am eager to learn them.
}}
...
\begin{itemize}
    \item Development of web applications, leveraging cloud technologies, for data visualization with React, Vue, Angular, and MaterialUI, with TypeScript or JavaScript.
 \item Translating client requirements into technical solutions, participating in meetings to ensure alignment with stakeholder expectations
     \item Delivering and testing urgent fixes, programming automated tests with Java/Selenium, Cypress, and unit testing with Jest
...
{\hypersetup{urlcolor=black}\href{https://carla.org/}{CARLA.org}} used for autonomous driving research.
    ...
    \item Programming traffic scenarios which describe traffic situations and vehicle behaviors like a lane change with Python.

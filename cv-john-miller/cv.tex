...
\definecolor{cvblue}{HTML}{3C3C3C} %1E3A8A
...
\newcommand{\headleft}[1]{%
    \vspace*{3ex}%
    \centering % Centers the text
    {\large\textsc{\textbf{#1}}}\par % Makes the text larger
    \vspace*{-1.5ex}%
    \hrulefill\par%
    \vspace*{0.8ex}%
}
...
\begin{tikzpicture}
    \clip (0,0) circle (2cm);
    \node at (0,0) {\includegraphics[width=4cm]{aaf.jpg}}; 
\end{tikzpicture}%
\hfill\null
...
\headleft{Contact}
{\small
\begin{tabular}{@{}l@{\hspace{0.5em}}l} % Left-align icons and add spacing between columns
...
\textbf{Languages:}   & \\[1ex] % Empty space for separation
\end{tabular}
...
\begin{itemize}
    \item Development of web applications, leveraging cloud technologies, for data visualization using frameworks like React, Vue, and Angular, using frontend libraries like MaterialUI and Bootstrap, with TypeScript or JavaScript.

...
\definecolor{cvcolor}{HTML}{333333} %1E3A8A 3C3C3C
%\definecolor{cvcolor}{HTML}{FF0000} %1E3A8A 3C3C3C
...
\NewDocumentCommand{\headright}{o m}{%
    \IfNoValueTF{#1}{%
        % Default case: With line
        \noindent\textcolor{cvcolor}{\rule{\linewidth}{1pt}}\par
        \vspace*{1ex}%
    }{%
        % Optional case: Without line
        \vspace*{2ex}%
    }%
    {\large\textbf{\textcolor{cvcolor} {\MakeUppercase{#2}}}}\par % Makes the text uppercase
    %\vspace*{0.5ex}
}

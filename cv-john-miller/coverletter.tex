...
\fancyfoot[C]{%
    \vspace{0.2pt}\\
    {\large \href{mailto:\email}{\faEnvelope}} \hspace{0.5cm}
    {\large \href{https://wa.me/\phone}{\faWhatsapp}} \hspace{0.5cm}
    {\large \href{\github}{\faGithub}} \hspace{0.5cm}
    {\large \href{\linkedin}{\faLinkedinSquare}}
}

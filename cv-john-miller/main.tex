...
{\small
Software Engineer with 4+ years of experience in Python, modern web development frameworks, and Java. With a background in Electrical Engineering, I discovered my passion for programming during my university studies and began working as a programmer while still a student, continuing in the field since graduating in 2020.\\
Being a team player, I thrive in collaborative environments, enjoying the opportunity to work together to solve complex challenges and achieve goals.
Personally, I prefer Python over Java and I enjoy learning (and teaching) new technologies, automating processes, and writing well-structured and robust code to reduce complexity.\\
Being solution-oriented yet critical, I constantly aim to develop better solutions and improve the efficiency.\\
%I like to bring my creativity, dedication, and problem-solving skills to the table in order to contribute to team success.
...
\begin{itemize}[leftmargin=1em]
    ...
    \item \textbf{Frontend}\\
     React, Vue, Angular, Redux, Material UI, Bootstrap, Tailwind CSS
    \item \textbf{Backend}\\
